...
<form id="cadastroForm" action="zinserir/inserircomercial.php" method="POST" style="display: block;">
<h2>Cadastre seu Comercio</h2>
         Nome:
        <input type="text" name="cxnome" placeholder="Exemplo: Seu nome"/><br/>
         Comercio:
        <input type="text" name="cxcomercio" placeholder="Exemplo:Nome do seu Comercio"/><br/>
         Telefone:
        ...
        <p>Já cadastrou seu comércio? 
            <a href="#" onclick="toggleForms()" style="color: black;">Busque-o</a> 
                ...
                <form action="zconsulta/consultanomecomercio.php" id="consultaForm" method="POST" style="display: none;">
                <h2>Consulte</h2>
                    <div class="container_form__itens">
                        <div class="container_form_itens__inputs">
                            <label for="">Digite o nome completo da empresa:</label></br></br>
